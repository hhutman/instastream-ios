...
/* input and output GPUImage filters */
@property (nonatomic, strong, nullable, readonly) GPUImageVideoCamera *sourceFilter;
@property (nonatomic, strong, nullable, readonly) GPUImageFilter *sinkFilter;

// dont touch filters
@property (nonatomic, assign) BOOL useCustomFilters;
